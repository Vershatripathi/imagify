...
<img src={assets.sample_img_1} alt="" className='w-80 xl:w-96 rounded-lg' />
   <div>
    ...
    <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator.Whether you need stunning visuals or unique imagery,our tool transforms your text into eye-catching image with just a few clicks.Imagine it, describe it and watch it coming to life instantly.</p>
